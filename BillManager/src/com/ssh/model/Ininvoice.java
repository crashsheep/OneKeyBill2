...
/**
 * Ininvoice entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "ininvoice", catalog = "fapiaoguanli")
public class Ininvoice implements java.io.Serializable {
	...
	/** full constructor */
	public Ininvoice(String invoiceNum, String balanceNum, String outName,
